...
image_captions_file = "/home/xim/xu2202_main/IDEAL-main/filelists/ND1/ND1/splits/ND1_captions.csv"  # Update this path
...
data_dir = os.path.join(pathname, "/home/xim/xu2202_main/IDEAL-main/filelists/ND1/ND1/data")
splits_dir = os.path.join(pathname, "/home/xim/xu2202_main/IDEAL-main/filelists/ND1/ND1/splits")

# Create JSON files
create_json(data_dir, os.path.join(splits_dir, "train.txt"), "base.json", start_label=10)
create_json(data_dir, os.path.join(splits_dir, "val.txt"), "val.json", start_label=30)
create_json(data_dir, os.path.join(splits_dir, "test.txt"), "novel.json", start_label=50)
